...
class Upsells extends Base_Customizer {
	...
	/**
	 * Overrides nueve4_checkout_page_layout theme mod as 'standard' if Neve Pro addon is disabled or not activated.
	 *
	...
	private function section_upsells() {
		...
		$this->add_section(
			new Section(
				...
				array(
					'priority' => -100,
					'title'    => esc_html__( 'Neve PRO Features', 'nueve4' ),
					'url'      => $this->upsell_url,
				),
	...
	private function control_upsells() {
		$this->add_control(
			new Control(
				...
				[ 'sanitize_callback' => 'sanitize_text_field' ],
				[
					'text'        => esc_html__( 'Neve PRO Features', 'nueve4' ),
		...
		$hfg_footer_text                = __( 'Neve PRO Features', 'nueve4' );
