...
$svg_icon    = nueve4_kses_svg( PaletteSwitch::get_icon( $icon_type, $icon_custom ) );
...
<div class="toggle-palette">
	<a class="toggle palette-icon-wrapper" aria-label="<?php echo esc_attr__( 'Palette Switch', 'nueve4' ); ?>" href="#" <?php echo $amp_state; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
