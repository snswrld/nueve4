...
$menu_icon_class  = apply_filters( 'nueve4_menu_icon_classes', 'hamburger is-active ' );
...
<div
	...
	<div id="header-menu-sidebar-bg" class="header-menu-sidebar-bg">
		...
		<div class="<?php echo esc_attr( $close_classes ); ?>">
			...
			<?php
			esc_html_e( 'Navigation Menu', 'nueve4' );
			?>
					</span>
			</button>
		</div>
		...
		<div id="header-menu-sidebar-inner" class="<?php echo esc_attr( $inner_classes ); ?>">
			 ...
			 * @since 3.0.6
			 */
			do_action( 'nueve4_before_mobile_menu_content' );
			?>
			 ...
			 * @since 3.0.6
			 */
			do_action( 'nueve4_after_mobile_menu_content' );
			?>
		</div>
	</div>
</div>
