...
class Footer extends Abstract_Builder {
	...
	public function init() {
		 ...
		 * This will apply from Nueve4 3.5.8 and offer backward compatibility for users that have not set a mobile footer layout.
		 *
		 * @since 3.5.8
		 */
		add_filter(
	...
	public function add_footer_component( $builder, $row, $slot ) {
		...
		$output .= sprintf(
		/* translators: %1$s is Theme Name ( Nueve4 ), %2$s is WordPress */
			esc_html__( '%1$s | Powered by %2$s', 'nueve4' ),
			wp_kses_post( '<p><a href="https://themeisle.com/themes/nueve4/" rel="nofollow">Nueve4</a>' ),
