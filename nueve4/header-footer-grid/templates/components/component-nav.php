...
$additional_menu_class = apply_filters( 'nueve4_additional_menu_class', ' menu-' . $device_class );
...
$container_classes = apply_filters( 'nueve4_additional_menu_container_class', $container_classes );
...
<div class="nv-nav-wrap">
	<div role="navigation" class="<?php echo esc_attr( join( ' ', $container_classes ) ); ?>"
			aria-label="<?php esc_attr_e( 'Primary Menu', 'nueve4' ); ?>">
		...
		echo wp_nav_menu(
			[
				...
				'container'      => 'ul',
				'walker'         => '\Nueve4\Views\Nav_Walker',
				'fallback_cb'    => '\Nueve4\Views\Nav_Walker::fallback',
				'echo'           => false,
			]
		);
		?>
