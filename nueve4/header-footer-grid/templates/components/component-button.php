...
$text         = apply_filters( 'nueve4_translate_single_string', $text, Button::TEXT_ID );
...
$button_link = apply_filters( 'nueve4_translate_single_string', $button_link, Button::LINK_ID );
?>
