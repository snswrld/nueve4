			...
			<div class="textwidget">
				...
				echo sprintf(
					...
					sprintf(
						...
						__( 'Replace this widget content by going to %s and add widgets into this widget area.', 'nueve4' ), //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						sprintf(
							...
							sprintf( __( 'Appearance %1$s Customize %2$s Footer %3$s', 'nueve4' ), '&rarr;', '&rarr;', '&rarr;' ), //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
