...
/**
 * The class responsible for instantiating new Nueve4 features.
 *
 * @package    Nueve4\Core
...
class Factory {
	 ...
	 */
	public function __construct( $modules, $namespace = '\\Nueve4\\' ) {
	...
	/**
	 * The build method for creating a new Nueve4 module class.
	 *
	 * @since   1.0.0
	 * @access  public
	 *
