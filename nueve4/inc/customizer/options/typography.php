...
use Nueve4\Customizer\Controls\React\Typography_Extra_Section;
	...
	private function controls_font_pairs() {
		...
		$this->add_control(
			new Control(
				...
				'\Nueve4\Customizer\Controls\React\Font_Pairings'
			)
		);
	}
	...
	private function controls_typography_general() {
		...
		$this->add_control(
			new Control(
				...
				'\Nueve4\Customizer\Controls\React\Font_Family'
			)
		);
		/**
		...
		foreach ( [ 'h1', 'h2', 'h3', 'h4', 'h5', 'h6' ] as $heading_id ) {
			$this->add_control(
				new Control(
					...
					'Nueve4\Customizer\Controls\React\Heading'
				)
			);
